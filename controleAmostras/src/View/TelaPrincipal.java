...
public class TelaPrincipal extends javax.swing.JFrame {
  ...
  // End of variables declaration//GEN-END:variables
    ...
    private boolean verificarSomaMassas() {
        ...
        if (!resposta) {
            JOptionPane.showMessageDialog(null, "Atenção! A soma da Massa de Eletrólito com a Massa de Aditivo deve ser maior ou igual a Massa de Pigmento Teórica.", "Valores não conferem", JOptionPane.WARNING_MESSAGE);
